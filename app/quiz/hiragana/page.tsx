...
export default function HiraganaQuizPage() {
  ...
  const restartQuiz = () => {
    ...
    if (hiragana.length > 0) {
      const questions = generateQuizQuestions(hiragana)
      setQuizQuestions(questions)
    }
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="text-center mb-8">
        <h1 className="text-3xl font-bold tracking-tight mb-4">Hiragana Quiz</h1>
        <p className="text-lg text-muted-foreground">Select the correct reading for each hiragana character</p>
      </div>
